...
const NEW_HOMEOWNER_STARTER_CATALOG: StarterItemDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Wash or replace indoor air-handler filters per manufacturer—often every one to three months with pets or heavy use.",
    category: "HVAC",
    priority: "medium",
  ...
  },
  {
    ...
    requiresHeatPump: true,
    title: "Yearly heat pump maintenance",
    description:
      "Book professional tune-up (coils, refrigerant check, drainage, defrost). Typical once per year; many owners align with spring or fall.",
    category: "HVAC",
    priority: "medium",
  ...
  },
  {
    ...
    description:
      "Gauge in the green zone, pin intact, accessible mount, not expired—kitchen and garage at minimum.",
    category: "SAFETY",
    priority: "medium",
    estimated_duration_minutes: 15,
    interval_days: 365,
  ...
  },
  {
    ...
    description:
      "Press test on each unit; replace batteries or devices per manufacturer. Include CO alarms where required.",
    category: "SAFETY",
    priority: "high",
  ...
  },
  {
    ...
    description:
      "Pull the metal mesh filters (check under an over-the-range microwave too). Degrease in hot soapy water or the dishwasher if allowed; swap charcoal filters if your hood uses them.",
    category: "APPLIANCES",
    priority: "medium",
    estimated_duration_minutes: 20,
    interval_days: 60,
